...
CREATE TABLE n_movie(id string, actors string, binding string, directors string, genres string, languages string, starrings string, studios string, title string, r_date string, products string, year int, month int, week int)
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde'
WITH SERDEPROPERTIES (
   "separatorChar" = "\,",   
   "quoteChar"     = "\""   
...
STORED AS ORC;
load data local inpath '/home/hadoop/final_data/movies.csv' overwrite into table n_movie;